...
\begin{algorithm}[H]
    ...
    \end{algorithmic}
\end{algorithm}
\todo[inline]{fix algorithm}

\todo[inline]{conjugate prior of precision. flexible prior}
...
This leaves us with the choice of prior distribution of the parameters.
...
\todo[inline]{exponentially weighted}
