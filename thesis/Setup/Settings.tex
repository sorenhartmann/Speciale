...
{ % If false
\titleformat{\part}[display]{\sffamily\bfseries\huge \centering}{\bfseries\Huge \thepart}{1em}{\thispagestyle{empty}}{}
...
\titleformat{\subsection}{\sffamily\bfseries\large}{\thesubsection}{1em}{\raggedright}
\titleformat{\subsubsection}{\sffamily\bfseries\normalsize}{\thesubsubsection}{1em}{\raggedright}
\newcommand\TitleFont[1]{{\sffamily\bfseries #1}}
\newcommand\titlefont[1]{{\sffamily#1}}
}
\urlstyle{sf}
...
\newcommand{\footerfamiliy}{\sffamily}
\fancypagestyle{main}{% All normal pages
    \fancyhead{}
    \fancyfoot{}
    \renewcommand{\headrulewidth}{0pt}
    \fancyfoot[LE,RO]{\footerfamiliy\footnotesize \thepage}
    \fancyfoot[RE,LO]{\footerfamiliy\footnotesize \thesistitle} % - \rightmark
...
\fancypagestyle{plain}{% Chapter pages
    ...
    \renewcommand{\headrulewidth}{0pt}
    \fancyfoot[LE,RO]{\footerfamiliy\footnotesize \thepage}
    \fancyfoot[RE,LO]{\footerfamiliy\footnotesize \thesistitle} % - \leftmark
    \fancyhfoffset[E,O]{0pt}
}
