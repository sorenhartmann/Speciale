\chapter{Simulated Polynomial Regression - Sampel Joint distributions} \label{apx:simulated-joint}
...
\begin{table}[H]
    ...
    \caption{Top hyperparameters for small convolutional model trained using SGHMC on the CIFAR10 dataset according to optuna sweep.}
...
\begin{table}[H]
    ...
    \caption{Top hyperparameters for small convolutional model trained using SGHMC (with variance estimation) on the CIFAR10 dataset according to optuna sweep.}
...
\begin{table}[H]
    ...
    \caption{Top hyperparameters for small convolutional model trained using VI the on CIFAR10 dataset according to optuna sweep.}
...
\begin{table}[H]
    ...
    \caption{Top hyperparameters for small convolutional model trained using VI (with exponentially scaled KL weight) on the CIFAR10 dataset according to optuna sweep.}
